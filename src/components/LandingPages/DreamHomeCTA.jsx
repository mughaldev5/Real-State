...
const DreamHomeCTA = () => {
  return (
    <div className='absulote bottom-0 left-0 right-0 mx-auto flex lg:flex-row flex-col justify-between items-center h-50 2xl:w-7xl xl:w-6xl lg:w-5xl md:w-3xl sm:w-xl pr-18 pl-18 bg-orange-600 shadow-lg z-20 -mb-25'>
